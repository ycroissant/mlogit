...
not only the preferred alternative. The relevant model for this kind of
...
be 3-1-4-2 can be written as follow :
...
; the ranking for one individual among J alternatives is written as
...
whether a specific platform is currently owned, the age of the
