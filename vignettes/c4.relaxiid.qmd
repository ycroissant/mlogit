...
reflevel = 'car', alt.subset = c("car", "train", "air"), heterosc = TRUE, hessian = FALSE)
...
lh.heter <- car::linearHypothesis(hl.MC, c('sp.air = 1', 'sp.train = 1'))
``` 
...
lh.nest <- car::linearHypothesis(nl2.fdi, c("iv:BE = 1", "iv:DE = 1",
...
constPar = c('iv:PT' = 1, 'iv:IE' = 1))
lh.unest <- car::linearHypothesis(nl2.fdi, c("iv:BE = iv:DE", "iv:BE = iv:ES", 
