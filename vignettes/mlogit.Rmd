...
mutually exclusive alternatives. Since the seminal works of Daniel 
McFadden [@MCFAD:74, MCFAD:78] who won the Nobel prize in economics "for
...
explained by the price and the catch expectancy, @DIPA:JAIN:94
...
modeled as the realisation of a random deviate. 
...
relevant R packages].  `mlogit` still provides the widest set of
estimators for random utility models and, moreover, its syntax has
been adopted by other `R` packages. Those packages provide useful
additions to `mlogit`:
