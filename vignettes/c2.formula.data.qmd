...
has a nice `print` method. In the rest of this document, we'll always
coerce the original data frame to a tibble before using `dfidx`:
...
ModeCanada <- as_tibble(ModeCanada)
