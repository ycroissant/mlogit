...
lh.mxc <- car::linearHypothesis(Train.mxlc, c("chol.time:time = 0",
...
lh.corr <- car::linearHypothesis(Train.mxlc, c("chol.time:change = 0",
...
The results are presented in @tab-risktr.


```{r}
#| label: "results for RiskyTransport"
#| results: "asis"
